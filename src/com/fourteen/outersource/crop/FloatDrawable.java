package com.fourteen.outersource.crop;
...
public class FloatDrawable extends Drawable {
	...
	public void draw(Canvas canvas) {
		...
		// 四周的角
		/*
		 * //左上 mCropPointDrawable.setBounds(left, top,
		 * left+mCropPointDrawable.getIntrinsicWidth(),
		 * top+mCropPointDrawable.getIntrinsicHeight());
		 * mCropPointDrawable.draw(canvas);
		 * 
		 * //右上
		 * mCropPointDrawable.setBounds(right-mCropPointDrawable.getIntrinsicWidth
		 * (), top, right, top+mCropPointDrawable.getIntrinsicHeight());
		 * mCropPointDrawable.draw(canvas);
		 * 
		 * //左下 mCropPointDrawable.setBounds(left,
		 * bottom-mCropPointDrawable.getIntrinsicHeight(),
		 * left+mCropPointDrawable.getIntrinsicWidth(), bottom);
		 * mCropPointDrawable.draw(canvas);
		 * 
		 * //右下
		 * mCropPointDrawable.setBounds(right-mCropPointDrawable.getIntrinsicWidth
		 * (), bottom-mCropPointDrawable.getIntrinsicHeight(), right, bottom);
		 * mCropPointDrawable.draw(canvas);
		 */
