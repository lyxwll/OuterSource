package com.fourteen.outersource.network.bitmap;
...
import com.fourteen.outersource.network.bitmap.BitmapSDLoaderTask.BitmapSDLoadListener;
import com.fourteen.outersource.network.bitmap.BitmapTransitionDrawable.BitmapTransitionCallback;
...
public class BitmapDownloader {
	 ...
	 */
	public class Download implements BitmapDownloaderTask.BitmapDownloadListener, BitmapLoaderTask.BitmapLoadListener, BitmapSDLoadListener{
		/**
		 * 位图资源的网络URL地址
		 */
		private String mUrl;
		...
		public Download(String url, ImageView imageView) {
			...
			//拼装成URL
			this.mUrl = ServerAddress.getImageDownloadAddress() + url;
			//弱引用
		...
		public void sdOnLoadError() {
			Logg.d(TAG, "onLoadError from file system: " + mUrl);
			ImageView imageView = getImageView();
			if (imageView != null && this == imageView.getTag(DOWNLOAD_TAG)) {
				imageView.setTag(DOWNLOAD_TAG, null);
				loadErrorDrawable(imageView);
		...
		public void sdOnLoadCancelled() {
			Logg.d(TAG, "onLoadCancelled from filesystem: " + mUrl);
			ImageView imageView = getImageView();
			if (imageView != null && this == imageView.getTag(DOWNLOAD_TAG)) {
				imageView.setTag(DOWNLOAD_TAG, null);
				loadInProgressDrawable(imageView);
