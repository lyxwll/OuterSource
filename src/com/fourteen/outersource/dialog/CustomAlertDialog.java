...
public class CustomAlertDialog extends AlertDialog implements DialogInterface {
    ...
    protected CustomAlertDialog(Context context, int theme) {
        super(context, theme);
        mAlert = new CustomAlertController(context, this, getWindow());
    }
    ...
    public static class Builder extends AlertDialog.Builder {
        ...
        /**
         * Constructor using a context for this builder and the {@link CustomAlertDialog} it creates.
         */
        public Builder(Context context) {
        	super(context);
            P = new CustomAlertController.AlertParams(context);
        }
        ...
        /**
         * Creates a {@link CustomAlertDialog} with the arguments supplied to this builder. It does not
        ...
        /**
         * Creates a {@link CustomAlertDialog} with the arguments supplied to this builder and
