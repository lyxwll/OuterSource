...
package com.fourteen.outersource.dialog;
...
public class CustomAlertController{
	...
	public static int m_MyAlertContentViewId=R.layout.custom_alert_dialog; //默认的对话框布局ID
    ...
    private void centerButton(Button button) {
        ...
        //leftSpacer.setVisibility(View.VISIBLE); //不显示左右spacer
        //View rightSpacer = mWindow.findViewById(R.id.rightSpacer);
        //rightSpacer.setVisibility(View.VISIBLE); //不显示左右spacer
    }
    ...
    private void setBackground(LinearLayout topPanel, LinearLayout contentPanel,
        ...
        int fullDark = R.drawable.dialog_popup_full;
        int topDark = R.drawable.dialog_popup_top;
        int centerDark = R.drawable.dialog_popup_center;
        int bottomDark = R.drawable.dialog_popup_bottom;
        int fullBright = R.drawable.dialog_popup_full;
        int topBright = R.drawable.dialog_popup_top;
        int centerBright = R.drawable.dialog_popup_center;
        int bottomBright = R.drawable.dialog_popup_bottom;
        int bottomMedium = R.drawable.dialog_popup_bottom;
    ...
    public static class AlertParams {
        ...
        private void createListView(final CustomAlertController dialog) {
            final RecycleListView listView = (RecycleListView)
                    mInflater.inflate(R.layout.custom_select_dialog, null);
            ListAdapter adapter;
            
            if (mIsMultiChoice) {
                if (mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(
                            mContext, R.layout.custom_select_dialog_multichoice, android.R.id.text1, mItems) {
                        @Override
                    ...
                    adapter = new CursorAdapter(mContext, mCursor, false) {
                        ...
                        public View newView(Context context, Cursor cursor, ViewGroup parent) {
                            return mInflater.inflate(R.layout.custom_select_dialog_multichoice,
                                    parent, false);
                        }
                ...
                int layout = mIsSingleChoice 
                        ? R.layout.custom_select_dialog_singlechoice : R.layout.custom_select_dialog_item;
                if (mCursor == null) {
