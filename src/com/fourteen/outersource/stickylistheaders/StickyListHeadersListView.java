...
import com.fourteen.outersource.stickylistheaders.WrapperViewList.LifeCycleListener;
...
//            }
    ...
    private boolean requireSdkVersion(int versionCode) {
        if (Build.VERSION.SDK_INT < versionCode) {
            Logg.e("StickyListHeaders", "Api lvl must be at least "+versionCode+" to call this method");
            return false;
        }
        return true;
    }
